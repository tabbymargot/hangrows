...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'foodiepro' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'foodiepro' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'foodiepro' ),
		'cyrillic'     => __( 'Cyrillic', 'foodiepro' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'foodiepro' ),
		'devanagari'   => __( 'Devanagari', 'foodiepro' ),
		'greek'        => __( 'Greek', 'foodiepro' ),
		'greek-ext'    => __( 'Greek Extended', 'foodiepro' ),
		'khmer'        => __( 'Khmer', 'foodiepro' ),
		'latin'        => __( 'Latin', 'foodiepro' ),
		'latin-ext'    => __( 'Latin Extended', 'foodiepro' ),
		'vietnamese'   => __( 'Vietnamese', 'foodiepro' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'foodiepro' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'foodiepro' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'foodiepro' ),
